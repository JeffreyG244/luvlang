...
const DataDeletion = () => {
    ...
    return (<Card className="border-red-200">
      ...
      <CardContent className="space-y-4">
        ...
        {!showConfirmation ? (<Button onClick={() => setShowConfirmation(true)} variant="destructive" className="w-full">
            ...
            <div>
              ...
              <input type="text" value={confirmText} onChange={(e) => setConfirmText(e.target.value)} className="w-full p-2 border border-gray-300 rounded-md" placeholder="DELETE MY DATA"/>
            </div>
            <div className="flex gap-2">
              <Button onClick={handleDataDeletion} disabled={isDeleting || confirmText !== 'DELETE MY DATA'} variant="destructive" className="flex-1">
