...
export default function UserProfileForm() {
    ...
    return (<form onSubmit={handleSubmit} className="space-y-4 p-4 bg-white rounded-xl shadow">
      ...
      <button type="submit" className="bg-pink-600 text-white p-2 rounded w-full hover:bg-pink-700">
        Submit Profile
      </button>
    </form>);
}
