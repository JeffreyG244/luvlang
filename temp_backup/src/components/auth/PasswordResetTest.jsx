    ...
    return (<Card className="w-full max-w-md">
      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Input id="test-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter email to test"/>
        </div>
        
        <Button onClick={testPasswordReset} disabled={loading || !email.trim()} className="w-full">
