...
import { Shield, AlertTriangle, CheckCircle, Eye, Search } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="border-green-200">
          ...
          <CardContent className="space-y-3">
            {redFlagCategories.map((category, index) => (<div key={index} className="p-3 bg-green-50 rounded-lg border border-green-200">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-medium text-sm">{category.category}</h4>
                  <div className="flex items-center gap-2">
                    <Badge variant={category.detected === 0 ? "outline" : "destructive"} className="text-xs">
                      {category.detected} detected
                    </Badge>
                    {category.detected === 0 ? (<CheckCircle className="h-4 w-4 text-green-500"/>) : (<AlertTriangle className="h-4 w-4 text-red-500"/>)}
                  </div>
                </div>
        ...
        <Card className="border-green-200">
          ...
          <CardContent className="space-y-3">
            {recentAlerts.map((alert, index) => (<div key={index} className="p-3 bg-green-50 rounded-lg border border-green-200">
      ...
      <Card className="border-green-200">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {safetyFeatures.map((feature, index) => (<div key={index} className="p-4 bg-green-50 rounded-lg border border-green-200">
                <div className="flex items-center justify-between mb-2">
