...
import { Shield, Database, MessageCircle, Users, Heart, AlertTriangle, CheckCircle, Activity, RefreshCw, Github } from 'lucide-react';
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {healthChecks.map((check, index) => (<div key={index} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                {check.icon}
