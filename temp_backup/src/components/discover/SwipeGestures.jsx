...
const SwipeGestures = ({ children, onSwipeLeft, onSwipeRight, swipeDirection, cardIndex }) => {
    ...
    return (<motion.div key={cardIndex} initial={{
            scale: 0.9,
            opacity: 0,
            rotateY: 15,
            y: 20
            ...
            stiffness: 100,
            damping: 15
        }} drag="x" dragConstraints={{ left: -150, right: 150 }} dragElastic={0.2} onDragEnd={handleDragEnd} whileDrag={{
            rotate: 12,
            scale: 1.08,
            cursor: 'grabbing',
            zIndex: 20,
