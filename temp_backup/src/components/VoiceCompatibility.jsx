...
const VoiceCompatibility = () => {
    ...
    return (<div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-center p-8 border-2 border-dashed border-gray-300 rounded-lg">
            {isRecording ? (<div className="text-center">
                ...
                <Button onClick={hasRecording ? analyzeVoice : startRecording} disabled={isAnalyzing} className="flex items-center gap-2">
                  {isAnalyzing ? (<>
      ...
      {/* Analysis Results */}
      {analysisComplete && (<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              {voiceMetrics.map((metric, index) => (<div key={index} className="space-y-2">
                  <div className="flex justify-between items-center">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {voiceMatches.map((match, index) => (<div key={index} className="border rounded-lg p-4">
                  ...
                  <div className="space-y-1">
                    {match.insights.map((insight, i) => (<p key={i} className="text-xs text-gray-500 flex items-center gap-1">
