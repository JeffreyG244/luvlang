        ...
        <div className="space-y-6">
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4">
              {profileSections.map((section, index) => (<div key={index} className="space-y-2">
                  <div className="flex justify-between items-center">
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-3">
              {aiSuggestions.map((suggestion, index) => (<div key={index} className="p-3 bg-purple-50 rounded-lg border border-purple-200">
                  <div className="flex items-center justify-between mb-1">
                    <h4 className="font-medium text-sm">{suggestion.category}</h4>
                    <Badge variant="outline" className={`text-xs ${suggestion.impact === 'Critical' ? 'border-green-300 text-green-700' :
          ...
          <div className="text-center">
            <Button onClick={runProfileAnalysis} disabled={isAnalyzing} className="bg-purple-600 hover:bg-purple-700">
              {isAnalyzing ? (<>
