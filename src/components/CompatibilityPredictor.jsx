...
const CompatibilityPredictor = () => {
    ...
    const overallScore = compatibilityFactors.reduce((acc, factor) => acc + (factor.score * factor.weight / 100), 0);
    return (<div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {["Sarah Chen", "Alex Rodriguez", "Emma Thompson"].map((name) => (<Button key={name} variant={selectedMatch === name ? "default" : "outline"} onClick={() => setSelectedMatch(name)} className="h-auto p-4">
      ...
      {predictionComplete && selectedMatch && (<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {compatibilityFactors.map((factor, index) => (<div key={index} className="space-y-2">
                  <div className="flex justify-between items-center">
              ...
              <CardContent className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <ul className="space-y-1">
                    {predictions.shortTerm.insights.map((insight, i) => (<li key={i} className="text-sm text-gray-600 flex items-center gap-2">
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <ul className="space-y-1">
                    {predictions.longTerm.insights.map((insight, i) => (<li key={i} className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2">
                  {predictions.challenges.map((challenge, i) => (<li key={i} className="text-sm text-gray-600 flex items-center gap-2">
