...
import { Heart, X, Zap, Brain } from "lucide-react";
...
const AIMatchingEngine = () => {
    ...
    return (<div className="space-y-6">
      ...
      {match && (<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Main Profile Card */}
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Button variant="outline" size="icon" onClick={handlePass} className="rounded-full">
                    <X className="h-4 w-4"/>
                  </Button>
                  <Button size="icon" onClick={handleLike} className="rounded-full bg-pink-500 hover:bg-pink-600">
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2">
                  {match.aiInsights.map((insight, index) => (<li key={index} className="flex items-center gap-2">
