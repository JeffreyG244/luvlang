...
const SwipeIndicators = ({ dragX, isVisible }) => {
    ...
    return (<div className="absolute inset-0 pointer-events-none z-10">
      {/* Like Indicator */}
      <motion.div className="absolute top-20 right-6 bg-emerald-500 text-white rounded-full p-4 shadow-2xl" style={{ opacity: likeOpacity }} animate={{
      ...
      {/* Pass Indicator */}
      <motion.div className="absolute top-20 left-6 bg-red-500 text-white rounded-full p-4 shadow-2xl" style={{ opacity: passOpacity }} animate={{
