...
const LegalSectionCard = ({ section }) => {
    return (<Card className="border-purple-200 hover:shadow-lg transition-shadow">
      <CardHeader>
      ...
      <CardContent>
        <div className="space-y-3">
          {section.items.map((item, index) => {
            ...
            return (<Link key={index} to={item.path} className="flex items-start gap-3 p-3 rounded-lg hover:bg-purple-50 transition-colors group">
